...
public class FulltimeEmployee extends Employee{
	...
	//CONSTRUCTOR
	/**
	 * Fulltime Employee constructur calls Employee constructor.
	 ...
	 */
	public FulltimeEmployee(String name_, String reg_num_, String position_, int start_year_, String[] monitor_file_) {
